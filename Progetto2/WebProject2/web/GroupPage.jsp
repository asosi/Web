...
<head>
    ...
    <script type="text/javascript">
        ...
        function PublicPost() {
            ...
            if (tes == "" || tes.length > 2000 ||  /^\s*$/.test(tes) || /[|&%<>+]/g.test(tes)) {
                t = 1;
            ...
            if(t==0&&f==0) {
                ...
                //CloseModalPost();
                document.addpost.action = "AddPost?numero="+idG+"&testopost="+tes+"&numeroElementi="+finale;
    ...
    <div class="navbar navbar-inverse barra">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Gruppi.jsp">Back to Groups</a>
            </div>
    ...
    <div class="container postContainer">
        ...
        <div style="width:100%">
                <table style="width:100%">
                    <!-- SINGLE POST -->
                        <%
                            groupPage.Stampa(groupPage.Post(idG,request), out);
                        %>
                </table>
        </div>
    </div>
